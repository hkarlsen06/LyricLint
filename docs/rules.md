...
| `quotes.typewriter` | Warning | Curly quotes, guillemets, low quotes, or a spacing acute accent beside a word occur in lyric text | Safe replacement for quote marks; preview a straight apostrophe for an acute accent; exclude unsupported markup | `G-TYPEWRITER` |
